...
```{r}
# Get median across contigs in each sample
## need to choose between closest references for the contigs with two different ones if you want to use median for the species plots
plot_RPKM_dsr_median <- samples_unique_genes_with_names %>%
