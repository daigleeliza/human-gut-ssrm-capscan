...
closestRefInfo_allScoreThresholdHits_capsule_2015 <- read_csv(paste0(treeInfoDir, "closestRefInfo_allScoreThresholdHits_no_2018_capsule.csv"))
```
...
closestRefInfo_allScoreThresholdHits_wSingleClosestRef_capsule_2015 <- closestRefInfo_allScoreThresholdHits_capsule_2015 %>%
  mutate(single_closest_ref = sapply(closest_ref, get_single_ref))

# save as csv
write.csv(closestRefInfo_allScoreThresholdHits_wSingleClosestRef_capsule_2015,
          paste0(dataDir,"closestRefInfo_allScoreThresholdHits_wSingleClosestRef_capsule_2015.csv"),
          row.names = FALSE)
```
