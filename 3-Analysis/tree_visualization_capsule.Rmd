...
# get tree
```{r}
rooted_ref_tree <- read.tree(paste0(dataDir, "/RAxML_labelledTree_2015_2018_noBootstrap_rooted.newick"))
```
...
species_labels <- c("QUERY___Desulfitibacter_alkalitolerans_dsrB" = "Desulfitibacter alkalitolerans",
...
```{r}
# need to get rid of the legend for one of them
