...
```{r}
png("heatmap_sampleType.png", width = 8, height = 10, units = "in", res = 600)
...
draw(hm_sample_type, heatmap_legend_side = "right")
...
```{r}
png("heatmap_split.png", width = 8, height = 10, units = "in", res = 600)

hm_split <- pheatmap(
  matrix_capsule,  # Use capsule as base (colors handled by cell_fun)
