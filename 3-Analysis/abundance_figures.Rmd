...
capsule_type_summary <- samples_unique_subunit_RPKG %>%
  ...
  summarise(n_subjects=n_distinct(subject),
            n_median_all_subj = round(median(n_median),4),
            n_25pct = round(quantile(n_median, probs = 0.25),4),
            n_75pct = round(quantile(n_median, probs = 0.75),4),
            median_RPKG_all_subj = round(median(median_total_RPKG),4),
            RPKG_25pct = round(quantile(median_total_RPKG, probs = 0.25),4),
            RPKG_75pct = round(quantile(median_total_RPKG, probs = 0.75),4)) %>% 
...
col_fun <- colorRamp2::colorRamp2(seq(min_val, max_val, length.out = 25), 
                       viridis(25, begin = 0.7, end = 0.1))
...
hm_split <- pheatmap(
  ...
  col = viridis(25, begin = 0.7, end = 0.1),  # For legend
  cluster_rows = FALSE,
  cluster_cols = FALSE,
