...
# contig_colors <- c(
#   setNames(
#     colorspace::sequential_hcl(n = length(contigs_by_species$contigs[[1]]), palette = "Greens", l = c(40, 90)),
#     contigs_by_species$contigs[[1]]
#   ),
#   setNames(
#     colorspace::sequential_hcl(n = length(contigs_by_species$contigs[[2]]), palette = "Blues", l = c(30, 80)),
